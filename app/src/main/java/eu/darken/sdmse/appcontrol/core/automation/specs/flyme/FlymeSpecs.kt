package eu.darken.sdmse.appcontrol.core.automation.specs.flyme
...
class FlymeSpecs @Inject constructor(
    ...
    override suspend fun isResponsible(pkg: Installed): Boolean {
        if (settings.romTypeDetection.value() == RomType.FLYME) return true
    ...
    abstract class DIM {
        @Binds @IntoSet abstract fun mod(mod: FlymeSpecs): AppControlSpecGenerator
    }

    companion object {
        val TAG: String = logTag("AppControl", "Automation", "Flyme", "Specs")
