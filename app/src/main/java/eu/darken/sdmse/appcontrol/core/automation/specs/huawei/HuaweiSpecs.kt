package eu.darken.sdmse.appcontrol.core.automation.specs.huawei
...
class HuaweiSpecs @Inject constructor(
    ...
    override suspend fun isResponsible(pkg: Installed): Boolean {
        if (settings.romTypeDetection.value() == RomType.HUAWEI) return true
    ...
    abstract class DIM {
        @Binds @IntoSet abstract fun mod(mod: HuaweiSpecs): AppControlSpecGenerator
    }

    companion object {
        val TAG: String = logTag("AppControl", "Automation", "Huawei", "Specs")
