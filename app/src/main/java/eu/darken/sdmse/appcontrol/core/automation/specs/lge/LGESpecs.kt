package eu.darken.sdmse.appcontrol.core.automation.specs.lge
...
import eu.darken.sdmse.appcontrol.core.automation.specs.huawei.HuaweiSpecs.Companion.SETTINGS_PKG
...
class LGESpecs @Inject constructor(
    ...
    override suspend fun isResponsible(pkg: Installed): Boolean {
        if (settings.romTypeDetection.value() == RomType.LGE) return true
    ...
    abstract class DIM {
        @Binds @IntoSet abstract fun mod(mod: LGESpecs): AppControlSpecGenerator
    }

    companion object {
        val TAG: String = logTag("AppControl", "Automation", "LGE", "Specs")
    }
}