package eu.darken.sdmse.appcontrol.core.automation.specs.vivo
...
class VivoSpecs @Inject constructor(
    ...
    override suspend fun isResponsible(pkg: Installed): Boolean {
        if (settings.romTypeDetection.value() == RomType.VIVO) return true
    ...
    abstract class DIM {
        @Binds @IntoSet abstract fun mod(mod: VivoSpecs): AppControlSpecGenerator
    }

    companion object {
        val SETTINGS_PKG = "com.android.settings".toPkgId()

        val TAG: String = logTag("AppControl", "Automation", "Vivo", "Spec")
    }
