...
import eu.darken.sdmse.appcleaner.core.automation.specs.alcatel.AlcatelLabels
...
class AlcatelSpecs @Inject constructor(
    ...
    override suspend fun isResponsible(pkg: Installed): Boolean {
        if (settings.romTypeDetection.value() == RomType.ALCATEL) return true
    ...
    abstract class DIM {
        @Binds @IntoSet abstract fun mod(mod: AlcatelSpecs): AppControlSpecGenerator
    }

    companion object {
        val TAG: String = logTag("AppControl", "Automation", "Alcatel", "Specs")
