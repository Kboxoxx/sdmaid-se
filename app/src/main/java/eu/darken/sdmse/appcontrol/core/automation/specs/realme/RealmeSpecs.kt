package eu.darken.sdmse.appcontrol.core.automation.specs.realme
...
class RealmeSpecs @Inject constructor(
    ...
    abstract class DIM {
        @Binds @IntoSet abstract fun mod(mod: RealmeSpecs): AppControlSpecGenerator
    }

    companion object {
        val TAG: String = logTag("AppControl", "Automation", "Realme", "Specs")
