package eu.darken.sdmse.appcontrol.core.automation.specs.honor
...
class HonorSpecs @Inject constructor(
    ...
    override suspend fun isResponsible(pkg: Installed): Boolean {
        if (settings.romTypeDetection.value() == RomType.HONOR) return true
    ...
    abstract class DIM {
        @Binds @IntoSet abstract fun mod(mod: HonorSpecs): AppControlSpecGenerator
    }

    companion object {
        val SETTINGS_PKG = "com.android.settings".toPkgId()

        val TAG: String = logTag("AppControl", "Automation", "Honor", "Specs")
    }
